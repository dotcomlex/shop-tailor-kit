          ...
          <div className="px-4 py-3">
            ...
            <div className="flex gap-3">
              <div className="w-[150px] shrink-0">
                ...
                {gallery.length > 1 && (
                  <div
                    className="mt-2 flex w-[150px] items-center gap-1.5 overflow-x-auto snap-x scroll-px-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
                  >
                    {gallery.map((g, i) => (
                      <button
                        key={g.key}
                        ...
                        className={cn(
                          "relative h-[36px] w-[36px] shrink-0 snap-start overflow-hidden rounded-md border transition-all",
                          i === safeIdx
