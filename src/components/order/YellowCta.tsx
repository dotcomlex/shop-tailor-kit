  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-[hsl(var(--order-yellow-deep))] hover:shadow-[0_3px_0_hsl(var(--order-yellow-deep)),inset_0_1px_0_rgba(255,255,255,0.35)]",
    ...
    >
      ...
      <span className="pointer-events-none absolute right-2.5 flex h-9 w-9 items-center justify-center rounded-full bg-[hsl(var(--text-strong))] text-white">
        {loading ? (
          <Loader2 className="h-4.5 w-4.5 animate-spin" />
        ) : (
          <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" strokeWidth={2.75} />
        )}
      </span>
    </button>
  );
