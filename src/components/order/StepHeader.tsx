...
export function StepHeader({ number, title, rightLabel, subStrip }: StepHeaderProps) {
  return (
    <div className="overflow-hidden rounded-lg shadow-[0_1px_0_rgba(0,0,0,0.04)]">
      <div className="flex items-center justify-between bg-order-blue px-5 py-2.5 text-white sm:py-3.5">
      ...
      {subStrip && (
        <div className="bg-order-blue-soft px-5 py-1.5 text-[14px] text-[hsl(var(--text-body))] sm:py-2">
          {subStrip}
        </div>
      )}
    </div>
